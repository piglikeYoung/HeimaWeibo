...
- (void)setText:(NSString *)text
{
    ...
    [regexResults enumerateObjectsUsingBlock:^(JHRegexResult *result, NSUInteger idx, BOOL *stop) {
        ...
        if (result.isEmotion) { // 表情
            ...
            // 传递表情
            attach.emotion = [JHEmotionTool emotionWithDesc:result.string];
    ...
    // 设置字体
    [attributedText addAttribute:NSFontAttributeName value:JHStatusRichTextFont range:NSMakeRange(0, attributedText.length)];
